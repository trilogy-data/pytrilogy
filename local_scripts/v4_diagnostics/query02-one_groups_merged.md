...
- inputs: `-`
- hidden: `-`
- predecessors: `grp:[@condition]filter:d1:date.id:existence:local.relevent_week_seq:merge, grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id:merge, grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number:merge, grp:basic:d*:date.week_seq:sig:790097:merge, grp:basic:d*:date.week_seq:sig:fd265d:merge, grp:root:root:∅:merge, grp:root:root_d1:∅:merge, grp:window:d0:date.week_seq:merge`
- successors: `-`
...
```json
{
  "contributor_contracts": [
    ...
    {
      "group_id": "grp:basic:d*:date.week_seq:sig:fd265d",
      "output_addresses": [
        "date.week_seq",
...
- successors: `__final__:merge, grp:basic:d*:date.week_seq:sig:fd265d:lineage`
- input contracts:
```json
[
  {
...
## grp:basic:d*:date.week_seq:sig:790097
...
- inputs: `-`
- hidden: `-`
- predecessors: `grp:basic:d*:date.week_seq:sig:fd265d:lineage, grp:window:d0:date.week_seq:lineage`
- successors: `__final__:merge`

## grp:basic:d*:date.week_seq:sig:fd265d
...
- successors: `__final__:merge, grp:basic:d*:date.week_seq:sig:790097:lineage, grp:window:d0:date.week_seq:lineage`
- input contracts:
```json
[
  {
    "channel": "row_stream",
    "consumer_group_id": "grp:basic:d*:date.week_seq:sig:fd265d",
...
- hidden: `-`
- predecessors: `grp:basic:d*:date.week_seq:sig:fd265d:lineage, grp:root:root:∅:lineage`
- successors: `__final__:merge, grp:basic:d*:date.week_seq:sig:790097:lineage`
- input contracts:
```json
[
  {
    ...
    "may_project_dimension": true,
    "parent_group_id": "grp:basic:d*:date.week_seq:sig:fd265d",
    "preserve_keys": [
      "date.week_seq"
    ],
    "required_grain": [
...
- `grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id` -> `grp:basic:d*:date.week_seq:sig:fd265d` kind=lineage
- `grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number` -> `__final__` kind=merge
- `grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number` -> `grp:basic:d*:date.week_seq:sig:fd265d` kind=lineage
- `grp:basic:d*:date.week_seq:sig:790097` -> `__final__` kind=merge
- `grp:basic:d*:date.week_seq:sig:fd265d` -> `__final__` kind=merge
- `grp:basic:d*:date.week_seq:sig:fd265d` -> `grp:basic:d*:date.week_seq:sig:790097` kind=lineage
- `grp:basic:d*:date.week_seq:sig:fd265d` -> `grp:window:d0:date.week_seq` kind=lineage
...
- `grp:window:d0:date.week_seq` -> `grp:basic:d*:date.week_seq:sig:790097` kind=lineage
