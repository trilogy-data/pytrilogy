...
- inputs: `-`
- hidden: `-`
- predecessors: `grp:[@condition]filter:d1:date.id:existence:local.relevent_week_seq:merge, grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id:merge, grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number:merge, grp:basic:d*:date.id:sig:bee871:merge, grp:basic:d*:date.week_seq:sig:1f78cd:merge, grp:root:root:∅:merge, grp:root:root_d1:∅:merge, grp:window:d0:date.week_seq:merge`
- successors: `-`
...
```json
{
  "contributor_contracts": [
    ...
    {
      "group_id": "grp:basic:d*:date.id:sig:bee871",
      "output_addresses": [
    ...
    {
      "group_id": "grp:basic:d*:date.week_seq:sig:1f78cd",
      "output_addresses": [
...
- successors: `__final__:merge, grp:basic:d*:date.week_seq:sig:1f78cd:lineage`
- input contracts:
```json
[
  {
...
## grp:basic:d*:date.id:sig:bee871
...
- hidden: `-`
- predecessors: `grp:basic:d*:date.week_seq:sig:1f78cd:lineage, grp:window:d0:date.week_seq:lineage`
...
[
  {
    "channel": "row_stream",
    "consumer_group_id": "grp:basic:d*:date.id:sig:bee871",
    "may_project_dimension": true,
    "parent_group_id": "grp:basic:d*:date.week_seq:sig:1f78cd",
    "preserve_keys": [
      "date.week_seq",
      "date.id"
    ],
...
## grp:basic:d*:date.week_seq:sig:1f78cd
...
- successors: `__final__:merge, grp:basic:d*:date.id:sig:bee871:lineage, grp:window:d0:date.week_seq:lineage`
- input contracts:
```json
[
  {
    "channel": "row_stream",
    "consumer_group_id": "grp:basic:d*:date.week_seq:sig:1f78cd",
    "may_project_dimension": false,
...
- hidden: `-`
- predecessors: `grp:basic:d*:date.week_seq:sig:1f78cd:lineage, grp:root:root:∅:lineage`
- successors: `__final__:merge, grp:basic:d*:date.id:sig:bee871:lineage`
- input contracts:
```json
[
  {
...
- `grp:[@condition]filter:d1:date.id:existence:local.relevent_week_seq` -> `__final__` kind=merge
- `grp:[@condition]filter:d1:date.id:existence:local.relevent_week_seq` -> `grp:root:root:∅` kind=existence
- `grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id` -> `__final__` kind=merge
- `grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id` -> `grp:basic:d*:date.week_seq:sig:1f78cd` kind=lineage
- `grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number` -> `__final__` kind=merge
- `grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number` -> `grp:basic:d*:date.week_seq:sig:1f78cd` kind=lineage
- `grp:basic:d*:date.id:sig:bee871` -> `__final__` kind=merge
- `grp:basic:d*:date.week_seq:sig:1f78cd` -> `__final__` kind=merge
- `grp:basic:d*:date.week_seq:sig:1f78cd` -> `grp:basic:d*:date.id:sig:bee871` kind=lineage
- `grp:basic:d*:date.week_seq:sig:1f78cd` -> `grp:window:d0:date.week_seq` kind=lineage
...
- `grp:root:root_d1:∅` -> `grp:[@condition]filter:d1:date.id:existence:local.relevent_week_seq` kind=lineage
- `grp:window:d0:date.week_seq` -> `__final__` kind=merge
- `grp:window:d0:date.week_seq` -> `grp:basic:d*:date.id:sig:bee871` kind=lineage
