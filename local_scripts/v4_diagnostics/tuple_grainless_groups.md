...
- `grp:basic:d*:∅:sig:11c1f0` -> `__final__` kind=merge phase=pre_condition
- `grp:rowset:d0:pairs.cat|pairs.val:rowset:pairs` -> `__final__` kind=merge phase=pre_condition
- `grp:rowset:d0:pairs.cat|pairs.val:rowset:pairs` -> `grp:basic:d*:∅:sig:11c1f0` kind=lineage phase=pre_condition
