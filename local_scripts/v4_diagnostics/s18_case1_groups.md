...
- `grp:aggregate:d0:agg.s.period` -> `grp:basic:d*:agg.s.period|fut.s.period:sig:50d021` kind=lineage phase=pre_condition
- `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` -> `__final__` kind=merge phase=pre_condition
- `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` -> `grp:basic:d*:agg.s.period|fut.s.period:sig:50d021` kind=lineage phase=pre_condition
- `grp:basic:d*:agg.s.period|fut.s.period:sig:50d021` -> `__final__` kind=merge phase=pre_condition
- `grp:basic:d*:∅:sig:fddbe9` -> `__final__` kind=merge phase=pre_condition
- `grp:basic:d*:∅:sig:fddbe9` -> `grp:aggregate:d0:agg.s.period` kind=lineage phase=pre_condition
- `grp:basic:d*:∅:sig:fddbe9` -> `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` kind=lineage phase=pre_condition
...
- `grp:rowset:d0:fut.s.period:rowset:fut` -> `grp:basic:d*:∅:sig:fddbe9` kind=lineage phase=pre_condition
