...
- inputs: `-`
- hidden: `-`
- predecessors: `grp:[@condition]filter:d1:date.id:existence:local.relevent_week_seq:merge, grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id:merge, grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number:merge, grp:basic:d*:date.week_seq:sig:fd265d:merge, grp:root:root:∅:merge, grp:root:root_d1:∅:merge, grp:window:d0:date.week_seq:merge`
- successors: `-`
...
- `grp:aggregate:d0:date.week_seq:input:catalog_sales.item.id|catalog_sales.order_number|date.id` -> `grp:basic:d*:date.week_seq:sig:fd265d` kind=lineage phase=post_condition
...
- `grp:aggregate:d0:date.week_seq:input:date.id|web_sales.item.id|web_sales.order_number` -> `grp:basic:d*:date.week_seq:sig:fd265d` kind=lineage phase=post_condition
- `grp:basic:d*:date.week_seq:sig:fd265d` -> `__final__` kind=merge phase=post_condition
- `grp:basic:d*:date.week_seq:sig:fd265d` -> `grp:window:d0:date.week_seq` kind=lineage phase=post_condition
