...
- `grp:aggregate:d0:agg.s.period` -> `grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9` kind=lineage
- `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` -> `__final__` kind=merge
- `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` -> `grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9` kind=lineage
- `grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9` -> `__final__` kind=merge
...
- `grp:rowset:d0:agg.s.period:rowset:agg` -> `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` kind=lineage
