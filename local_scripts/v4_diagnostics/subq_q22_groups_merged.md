...
- `grp:[@condition]aggregate:d1:__preql_internal.all_rows:input:__preql_internal.all_rows|local.id` -> `__final__` kind=merge
- `grp:[@condition]aggregate:d1:__preql_internal.all_rows:input:__preql_internal.all_rows|local.id` -> `grp:[@condition]basic:d1:∅:sig:1fc31a` kind=lineage
- `grp:[@condition]basic:d1:∅:sig:1fc31a` -> `__final__` kind=merge
- `grp:[@condition]basic:d1:∅:sig:1fc31a` -> `grp:root:root:∅` kind=constraint
- `grp:root:root:∅` -> `__final__` kind=merge
- `grp:root:root_d1:∅` -> `__final__` kind=merge
- `grp:root:root_d1:∅` -> `grp:[@condition]aggregate:d1:__preql_internal.all_rows:input:__preql_internal.all_rows|local.id` kind=lineage
