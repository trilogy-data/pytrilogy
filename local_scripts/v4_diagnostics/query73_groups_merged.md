...
- `grp:aggregate:d0:store_sales.customer.id|store_sales.ticket_number:input:store_sales.item.id|store_sales.ticket_number` -> `__final__` kind=merge
- `grp:filter:d*:store_sales.customer.id|store_sales.ticket_number:sig:650095` -> `__final__` kind=merge
- `grp:filter:d*:store_sales.customer.id|store_sales.ticket_number:sig:650095` -> `grp:aggregate:d0:store_sales.customer.id|store_sales.ticket_number:input:store_sales.item.id|store_sales.ticket_number` kind=lineage
- `grp:root:root:∅` -> `__final__` kind=merge
- `grp:root:root:∅` -> `grp:aggregate:d0:store_sales.customer.id|store_sales.ticket_number:input:store_sales.item.id|store_sales.ticket_number` kind=lineage
- `grp:root:root:∅` -> `grp:filter:d*:store_sales.customer.id|store_sales.ticket_number:sig:650095` kind=lineage
