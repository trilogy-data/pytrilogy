...
- inputs: `-`
- hidden: `-`
- predecessors: `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period:merge, grp:aggregate:d0:agg.s.period:merge, grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9:merge, grp:rowset:d0:agg.s.period:rowset:agg:merge, grp:rowset:d0:fut.s.period:rowset:fut:merge`
- successors: `-`
- final contract:
```json
{
  "contributor_contracts": [
    ...
    {
      "group_id": "grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9",
      "output_addresses": [
        "local.r",
        "agg.s.period"
      ],
...
- hidden: `-`
- predecessors: `grp:rowset:d0:agg.s.period:rowset:agg:lineage`
- successors: `__final__:merge, grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9:lineage`
- input contracts:
```json
[
  {
...
- inputs: `agg.s.period, fut.s.period, fut.tot`
- hidden: `-`
- predecessors: `grp:rowset:d0:agg.s.period:rowset:agg:lineage, grp:rowset:d0:fut.s.period:rowset:fut:lineage`
- successors: `__final__:merge, grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9:lineage`
- input contracts:
```json
[
...
## grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9
...
[
  {
    "channel": "row_stream",
    "consumer_group_id": "grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9",
...
- hidden: `-`
- predecessors: `-`
- successors: `__final__:merge, grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period:lineage`

# Edges

- `grp:aggregate:d0:agg.s.period` -> `__final__` kind=merge phase=pre_condition
- `grp:aggregate:d0:agg.s.period` -> `grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9` kind=lineage phase=pre_condition
- `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` -> `__final__` kind=merge phase=pre_condition
- `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` -> `grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9` kind=lineage phase=pre_condition
- `grp:basic:d*:agg.s.period|fut.s.period:sig:6582d9` -> `__final__` kind=merge phase=pre_condition
- `grp:rowset:d0:agg.s.period:rowset:agg` -> `__final__` kind=merge phase=pre_condition
- `grp:rowset:d0:agg.s.period:rowset:agg` -> `grp:aggregate:d0:agg.s.period` kind=lineage phase=pre_condition
- `grp:rowset:d0:agg.s.period:rowset:agg` -> `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` kind=lineage phase=pre_condition
- `grp:rowset:d0:fut.s.period:rowset:fut` -> `__final__` kind=merge phase=pre_condition
- `grp:rowset:d0:fut.s.period:rowset:fut` -> `grp:aggregate:d0:agg.s.period:input:agg.s.period|fut.s.period` kind=lineage phase=pre_condition
