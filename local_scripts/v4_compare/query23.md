...
FROM
    "questionable"
WHERE
    INVALID_REFERENCE_BUG = 2000 and INVALID_REFERENCE_BUG = 2
),
puzzled as (
SELECT
    "premium"."sales_item_id" as "sales_item_id",
    "premium"."sales_order_id" as "sales_order_id",
    "premium"."sales_sales_channel" as "sales_sales_channel",
    CASE WHEN "premium"."sales_sales_channel" in ('WEB','CATALOG') THEN "premium"."sales_quantity" * "premium"."sales_list_price" ELSE NULL END as "_virt_filter_7664750597049030"
FROM
    "premium"),
rambunctious as (
SELECT
    "premium"."sales_billing_customer_first_name" as "sales_billing_customer_first_name",
    "premium"."sales_billing_customer_last_name" as "sales_billing_customer_last_name",
    sum("puzzled"."_virt_filter_7664750597049030") as "sales_total"
FROM
    "puzzled"
    RIGHT OUTER JOIN "premium" on "puzzled"."sales_item_id" = "premium"."sales_item_id" AND "puzzled"."sales_order_id" = "premium"."sales_order_id" AND "puzzled"."sales_sales_channel" = "premium"."sales_sales_channel"
GROUP BY
    1,
    2
HAVING
...
SELECT
    "rambunctious"."sales_billing_customer_last_name" as "c_last_name",
    "rambunctious"."sales_billing_customer_first_name" as "c_first_name",
    "rambunctious"."sales_total" as "sales_total"
FROM
    "rambunctious"
ORDER BY 
    "c_last_name" asc nulls first,
    "c_first_name" asc nulls first,
    "rambunctious"."sales_total" asc nulls first
