...
| --- | --- | --- | --- |
| v4 | 2539 | 34 | 135.56 ms |
| reference | 2700 | 38 | 31.01 ms |
| v4 / ref | 0.94x | 0.89x | 4.37x |
...
SELECT
	...
	ELSE null
	END ) > 1 and "store_sales_date_date"."D_YEAR" in (1999,2000,2001) and "store_sales_store_store"."S_COUNTY" in ('Orange County','Bronx County','Franklin Parish','Williamson County') THEN "store_sales_store_sales"."SS_ITEM_SK" ELSE NULL END) as "ticket_cnt"
FROM
...
ORDER BY 
    ...
    "store_sales_store_sales"."SS_TICKET_NUMBER" asc,
    "store_sales_store_sales"."SS_CUSTOMER_SK" asc
```
