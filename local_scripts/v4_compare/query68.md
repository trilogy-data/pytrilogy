...
SELECT
    ...
    "store_sales_store_sales"."SS_EXT_LIST_PRICE" as "store_sales_ext_list_price",
    "store_sales_store_sales"."SS_EXT_SALES_PRICE" as "store_sales_ext_sales_price",
    "store_sales_store_sales"."SS_EXT_TAX" as "store_sales_ext_tax",
...
SELECT
    ...
    "abundant"."store_sales_ext_list_price" as "store_sales_ext_list_price",
    "abundant"."store_sales_ext_sales_price" as "store_sales_ext_sales_price",
    "abundant"."store_sales_ext_tax" as "store_sales_ext_tax",
    "abundant"."store_sales_item_id" as "store_sales_item_id",
    "abundant"."store_sales_ticket_number" as "store_sales_ticket_number",
    "cooperative"."store_sales_sale_address_city" as "store_sales_sale_address_city"
FROM
    "abundant"
    LEFT OUTER JOIN "cheerful" on "abundant"."store_sales_date_id" = "cheerful"."store_sales_date_id"
    LEFT OUTER JOIN "questionable" on "abundant"."store_sales_store_id" = "questionable"."store_sales_store_id"
    LEFT OUTER JOIN "cooperative" on "abundant"."store_sales_sale_address_id" = "cooperative"."store_sales_sale_address_id"
    LEFT OUTER JOIN "thoughtful" on "abundant"."store_sales_household_demographic_id" = "thoughtful"."store_sales_household_demographic_id"
WHERE
    "cheerful"."store_sales_date_day_of_month" BETWEEN 1 AND 2 and ( "thoughtful"."store_sales_household_demographic_dependent_count" = 4 or "thoughtful"."store_sales_household_demographic_vehicle_count" = 3 ) and "cheerful"."store_sales_date_year" in (1999,2000,2001) and "questionable"."store_sales_store_city" in ('Fairview','Midway') and "abundant"."store_sales_customer_id" is not null
),
yummy as (
SELECT
    "uneven"."store_sales_customer_id" as "customer_id",
    "uneven"."store_sales_customer_id" as "store_sales_customer_id",
    "uneven"."store_sales_sale_address_city" as "store_sales_sale_address_city",
    "uneven"."store_sales_ticket_number" as "store_sales_ticket_number",
    sum("uneven"."store_sales_ext_list_price") as "_dn_list_price",
    sum("uneven"."store_sales_ext_sales_price") as "_dn_extended_price",
    sum("uneven"."store_sales_ext_tax") as "_dn_extended_tax"
FROM
    "uneven"
GROUP BY
    2,
...
SELECT
    ...
    "highfalutin"."customer_id" as "customer_id",
    "highfalutin"."customer_id" as "customer_id",
...
SELECT
    ...
    "yummy"."store_sales_ticket_number" as "dn_store_sales_ticket_number",
    "yummy"."store_sales_customer_id" as "dn_store_sales_customer_id",
    "yummy"."store_sales_sale_address_city" as "dn_store_sales_sale_address_city",
    "yummy"."_dn_extended_price" as "dn_extended_price",
    "yummy"."_dn_extended_tax" as "dn_extended_tax",
    "yummy"."_dn_list_price" as "dn_list_price",
    "wakeful"."customer_id" as "dn_customer_id",
...
FROM
    "yummy"
    INNER JOIN "wakeful" on "yummy"."customer_id" is not distinct from "wakeful"."customer_id"
WHERE
    "wakeful"."customer_address_city" != "yummy"."store_sales_sale_address_city"
