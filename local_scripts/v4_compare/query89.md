...
| --- | --- | --- | --- |
| v4 | 7166 | 116 | 267.34 ms |
| reference | 4336 | 68 | 115.22 ms |
| v4 / ref | 1.65x | 1.71x | 2.32x |
...
WHERE
    "physical_sales_date_date"."D_YEAR" = 1999 and ( ( "physical_sales_item_items"."I_CATEGORY" in ('Books','Electronics','Sports') and "physical_sales_item_items"."I_CLASS" in ('computers','stereo','football') ) or ( "physical_sales_item_items"."I_CATEGORY" in ('Men','Jewelry','Women') and "physical_sales_item_items"."I_CLASS" in ('shirts','birdal','dresses') ) )
),
juicy as (
SELECT
...
FROM
    "thoughtful"
    RIGHT OUTER JOIN "yummy" on "thoughtful"."physical_sales_date_month_of_year" = "yummy"."physical_sales_date_month_of_year" AND "thoughtful"."physical_sales_item_brand_name" = "yummy"."physical_sales_item_brand_name" AND "thoughtful"."physical_sales_item_category" is not distinct from "yummy"."physical_sales_item_category" AND "thoughtful"."physical_sales_item_class" is not distinct from "yummy"."physical_sales_item_class" AND "thoughtful"."physical_sales_store_company_name" is not distinct from "yummy"."physical_sales_store_company_name" AND "thoughtful"."physical_sales_store_name" = "yummy"."physical_sales_store_name"
GROUP BY
    1,
    2,
    3,
    4,
    5,
    "thoughtful"."physical_sales_date_month_of_year",
    "thoughtful"."physical_sales_item_class"),
concerned as (
SELECT
...
FROM
    "thoughtful"
    INNER JOIN "concerned" on "thoughtful"."physical_sales_item_brand_name" = "concerned"."physical_sales_item_brand_name" AND "thoughtful"."physical_sales_item_category" is not distinct from "concerned"."physical_sales_item_category" AND "thoughtful"."physical_sales_store_company_name" is not distinct from "concerned"."physical_sales_store_company_name" AND "thoughtful"."physical_sales_store_name" = "concerned"."physical_sales_store_name"
WHERE
    CASE
	WHEN "concerned"."avg_monthly_sales" != 0 THEN abs("thoughtful"."sum_sales" - "concerned"."avg_monthly_sales") / "concerned"."avg_monthly_sales"
	ELSE null
	END > 0.1

ORDER BY 
    "thoughtful"."sum_sales" - "concerned"."avg_monthly_sales" asc,
    coalesce("concerned"."physical_sales_store_name","thoughtful"."physical_sales_store_name") asc,
    coalesce("concerned"."physical_sales_item_category","thoughtful"."physical_sales_item_category") asc,
    "thoughtful"."physical_sales_item_class" asc,
    coalesce("concerned"."physical_sales_item_brand_name","thoughtful"."physical_sales_item_brand_name") asc,
    coalesce("concerned"."physical_sales_store_company_name","thoughtful"."physical_sales_store_company_name") asc,
