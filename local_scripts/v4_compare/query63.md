...
thoughtful as (
SELECT
    "cheerful"."store_sales_date_month_of_year" as "store_sales_date_month_of_year",
...
SELECT
    ...
    coalesce("cooperative"."store_sales_item_manager_id","thoughtful"."store_sales_item_manager_id") as "store_sales_item_manager_id"
FROM
    "cooperative"
    FULL JOIN "thoughtful" on "cooperative"."store_sales_item_manager_id" is not distinct from "thoughtful"."store_sales_item_manager_id")
SELECT
...
WHERE
    CASE
	WHEN "questionable"."avg_monthly_sales" > 0 THEN abs("questionable"."sum_sales" - "questionable"."avg_monthly_sales") / "questionable"."avg_monthly_sales"
	ELSE null
	END > 0.1
...
LINE 57:     avg("thoughtful"."sum_sales") as "avg_monthly_sales"
                 ^
```
