...
SELECT
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 16 AND 20 THEN 4
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 21 AND 25 THEN 5
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 1 THEN CASE
	WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	...
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 1 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 8 AND 18 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 459 AND 1459 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 57 AND 77 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 2 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 90 AND 100 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 2323 AND 3323 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 31 AND 51 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 3 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 142 AND 152 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 12214 AND 13214 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 79 AND 99 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 4 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 135 AND 145 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 6071 AND 7071 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 38 AND 58 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 5 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 122 AND 132 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 836 AND 1836 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 17 AND 37 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 26 AND 30 THEN 6
	ELSE null
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END ELSE NULL END as "B1_LP",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B1_CNT",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B1_CNTD",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B2_CNT",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B2_CNTD",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B3_CNT",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B3_CNTD",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B4_CNT",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B4_CNTD",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B5_CNT",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B5_CNTD",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B6_CNT",
    CASE WHEN CASE
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND 5 THEN 1
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 6 AND 10 THEN 2
	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 11 AND 15 THEN 3
	...
	END = 6 and ( INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price> BETWEEN 154 AND 164 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.coupon_amt> BETWEEN 7326 AND 8326 or INVALID_REFERENCE_BUG_<Missing source reference to store_sales.wholesale_cost> BETWEEN 7 AND 27 ) THEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.list_price>
	ELSE null
	END IS NOT NULL THEN 1 ELSE 0 END ELSE NULL END as "B6_CNTD"
...
LINE 3: 	WHEN INVALID_REFERENCE_BUG_<Missing source reference to store_sales.quantity> BETWEEN 0 AND...
                                            ^
```
