...
| --- | --- | --- | --- |
| v4 | 7110 | 125 | 60.63 ms |
| reference | 7868 | 136 | 44.07 ms |
| v4 / ref | 0.90x | 0.92x | 1.38x |
...
GROUP BY
    1,
    "yummy"."physical_sales_store_city",
    "yummy"."physical_sales_store_company_id",
    "yummy"."physical_sales_store_county",
    "yummy"."physical_sales_store_name",
    "yummy"."physical_sales_store_state",
    "yummy"."physical_sales_store_street_name",
    "yummy"."physical_sales_store_street_number",
    "yummy"."physical_sales_store_street_type",
    "yummy"."physical_sales_store_suite_number",
    "yummy"."physical_sales_store_zip")
SELECT
    "yummy"."physical_sales_store_name" as "physical_sales_store_name",
    "yummy"."physical_sales_store_company_id" as "physical_sales_store_company_id",
    "yummy"."physical_sales_store_street_number" as "physical_sales_store_street_number",
...
FROM
    "yummy"
    INNER JOIN "juicy" on "yummy"."physical_sales_store_id" = "juicy"."physical_sales_store_id"
ORDER BY 
    "yummy"."physical_sales_store_name" asc nulls first,
    "yummy"."physical_sales_store_company_id" asc nulls first,
    "yummy"."physical_sales_store_street_number" asc nulls first,
