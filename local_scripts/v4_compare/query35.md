...
ORDER BY 
    ...
    "customer_demographics_marital_status" asc nulls first,
    "customer_demographics_dependent_count" asc nulls first,
    "customer_demographics_employed_dependent_count" asc nulls first,
    "customer_demographics_college_dependent_count" asc nulls first
LIMIT (100)
```
