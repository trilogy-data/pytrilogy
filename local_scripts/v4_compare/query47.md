...
| --- | --- | --- | --- |
| v4 | 7680 | 110 | 195.98 ms |
| reference | 6059 | 90 | 134.06 ms |
| v4 / ref | 1.27x | 1.22x | 1.46x |
...
FROM
    "abundant"
WHERE
    "abundant"."physical_sales_date_year" = 1999
