...
ValueError: Invalid reference string found in query: SELECT
    :_q76_results_channel_a as "q76_results_channel",
    :_q76_results_col_name_a as "q76_results_col_name",
    INVALID_REFERENCE_BUG as "q76_results_d_year",
    INVALID_REFERENCE_BUG as "q76_results_d_qoy",
    INVALID_REFERENCE_BUG as "q76_results_i_category",
    coalesce(CASE
	...
	WHEN INVALID_REFERENCE_BUG is null THEN 1
	ELSE 0
	END) as "q76_results_sales_cnt",
    coalesce(INVALID_REFERENCE_BUG,INVALID_REFERENCE_BUG,INVALID_REFERENCE_BUG) as "q76_results_sales_amt"
