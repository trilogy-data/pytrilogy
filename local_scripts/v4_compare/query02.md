...
| --- | --- | --- | --- |
| v4 | 7723 | 125 | 20.97 ms |
| reference | 4649 | 80 | 12.21 ms |
| v4 / ref | 1.66x | 1.56x | 1.72x |
...
vacuous as (
SELECT
    "juicy"."_virt_agg_sum_1215995592885356" as "_virt_agg_sum_1215995592885356",
    "juicy"."_virt_agg_sum_1755492547499297" as "_virt_agg_sum_1755492547499297",
    "juicy"."_virt_agg_sum_3160525683686265" as "_virt_agg_sum_3160525683686265",
    "juicy"."_virt_agg_sum_3226984322777641" as "_virt_agg_sum_3226984322777641",
    "juicy"."_virt_agg_sum_5503961012463124" as "_virt_agg_sum_5503961012463124",
    "juicy"."_virt_agg_sum_5898269946212687" as "_virt_agg_sum_5898269946212687",
    "juicy"."_virt_agg_sum_6232287870778562" as "_virt_agg_sum_6232287870778562",
    "juicy"."sales_date_week_seq" as "sales_date_week_seq",
    lead("juicy"."_virt_agg_sum_1215995592885356", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_8434916643189094",
    lead("juicy"."_virt_agg_sum_1755492547499297", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_1513977696668684",
    lead("juicy"."_virt_agg_sum_3160525683686265", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_6726398054446491",
    lead("juicy"."_virt_agg_sum_3226984322777641", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_7589933802981203",
    lead("juicy"."_virt_agg_sum_5503961012463124", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_5402686874923245",
    lead("juicy"."_virt_agg_sum_5898269946212687", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_3355739386573542",
    lead("juicy"."_virt_agg_sum_6232287870778562", 53) over (order by "juicy"."sales_date_week_seq" asc ) as "_virt_window_lead_8846802885933861"
FROM
    "juicy")
SELECT
