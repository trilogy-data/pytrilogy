...
only in v4 (showing up to 5 of 65):
  1x  ('Unquestionably different demands may not turn worldwide false, wide police. Satisfied, littl', 'AAAAAAAAABAAAAAA', 'TN', 44.02941176, 34, 0.71718451, 31.57721205, 39.6, 5, 0.96218418, 38.10249336, 66.4, 5, 0.24920035, 16.54690303)
  1x  ('Especially other jeans must not say less difficult men. Thousands should not advance serious systems. Unchanged situations need physical actions. Double g', 'AAAAAAAAACAAAAAA', 'TN', 50.15151515, 33, 0.51322921, 25.73922252, 17.0, 2, 0.83189033, 14.14213562, 21.5, 2, 0.69066244, 14.8492424)
  1x  ('Public, annual h', 'AAAAAAAAAEAAAAAA', 'TN', 49.0, 29, 0.60301596, 29.54778213, 12.0, 1, None, None, 94.0, 1, None, None)
  1x  ('Alone other sales could interpret slightly relations. Fast social police give just british centuries. There sacred channels go so industrial, original systems; women might approach black members. C', 'AAAAAAAAAHAAAAAA', 'TN', 46.75, 24, 0.63898514, 29.87255538, 46.0, 2, 1.22975092, 56.56854249, 49.5, 2, 1.21422377, 60.1040764)
  1x  ('Great, tiny animals adopt then outcomes. Terms sweep less dry, physical signs. National, black terms adapt for a reasons; groups shall ', 'AAAAAAAAAIAAAAAA', 'TN', 46.08823529, 34, 0.65170002, 30.03570365, 1.0, 1, None, None, 55.0, 1, None, None)
only in ref (showing up to 5 of 4):
  1x  ('Total styles cannot assume companies. Cases may constitute shops. Local years meet still different, superb players. Delicate, peaceful ', 'AAAAAAAAEDAAAAAA', 'TN', 42.0, 1, None, None, 2.0, 1, None, None, 2.0, 1, None, None)
  1x  ('As short materials might go sometime new, tall skills. M', 'AAAAAAAAHGAAAAAA', 'TN', 31.0, 1, None, None, 1.0, 1, None, None, 19.0, 1, None, None)
  1x  ('However increasing dates meet. Large, ready goals mean now blind structures. Crea', 'AAAAAAAAJHAAAAAA', 'TN', 32.0, 1, None, None, 40.0, 1, None, None, 67.0, 1, None, None)
  1x  ('Functional, ', 'AAAAAAAAJKAAAAAA', 'TN', 90.0, 1, None, None, 24.0, 1, None, None, 52.0, 1, None, None)

## SQL size + execution time

| Source | Chars | Lines | Exec (min of 4) |
| --- | --- | --- | --- |
| v4 | 8278 | 153 | 40.04 ms |
| reference | 8099 | 125 | 21.96 ms |
| v4 / ref | 1.02x | 1.22x | 1.82x |
