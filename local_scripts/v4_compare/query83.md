...
| --- | --- | --- | --- |
| v4 | 7260 | 164 | 98.77 ms |
| reference | 5952 | 135 | 83.47 ms |
| v4 / ref | 1.22x | 1.21x | 1.18x |
...
FROM
    ...
    INNER JOIN "memory"."date_dim" as "sales_return_date_date" on "cooperative"."sales_return_date_id" = "sales_return_date_date"."D_DATE_SK"
WHERE
