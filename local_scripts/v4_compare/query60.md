...
| --- | --- | --- | --- |
| v4 | 3533 | 66 | 34.28 ms |
| reference | 3286 | 58 | 52.82 ms |
| v4 / ref | 1.08x | 1.14x | 0.65x |
...
WHERE
    "sales_bill_address_customer_address"."CA_GMT_OFFSET" = -5 and "sales_date_date"."D_YEAR" = 1998 and "sales_date_date"."D_MOY" = 9 and "yummy"."sales_item_name" in (select yummy."music_item_ids" from yummy where yummy."music_item_ids" is not null)
