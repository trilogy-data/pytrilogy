...
FROM
    "abundant"
WHERE
    INVALID_REFERENCE_BUG = 1998 and INVALID_REFERENCE_BUG = 9 and INVALID_REFERENCE_BUG = -5 and "abundant"."sales_item_text_id" in (select uneven."music_item_ids" from uneven where uneven."music_item_ids" is not null)
