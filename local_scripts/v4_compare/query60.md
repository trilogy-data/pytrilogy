...
| --- | --- | --- | --- |
| v4 | 3857 | 68 | 69.65 ms |
| reference | 3286 | 58 | 98.30 ms |
| v4 / ref | 1.17x | 1.17x | 0.71x |
...
WHERE
    "sales_bill_address_customer_address"."CA_GMT_OFFSET" = -5 and "sales_date_date"."D_YEAR" = 1998 and "sales_date_date"."D_MOY" = 9 and "uneven"."sales_item_name" in (select uneven."music_item_ids" from uneven where uneven."music_item_ids" is not null)
...
FROM
    "abundant"
WHERE
    "abundant"."sales_item_name" in (select uneven."music_item_ids" from uneven where uneven."music_item_ids" is not null)

GROUP BY
    2
ORDER BY 
    "abundant"."sales_item_name" asc,
    "total_sales" asc
LIMIT (100)
```
