...
| --- | --- | --- | --- |
| v4 | 4365 | 79 | 3.32 ms |
| reference | 3925 | 52 | 3.95 ms |
| v4 / ref | 1.11x | 1.52x | 0.84x |
...
juicy as (
SELECT
    sum("abundant"."physical_sales_net_paid") as "_virt_agg_sum_5757395975543459"
FROM
    "abundant"
GROUP BY
    "abundant"."physical_sales_customer_first_name",
    "abundant"."physical_sales_customer_id",
    "abundant"."physical_sales_customer_last_name",
...
SELECT
    "uneven"."physical_sales_customer_last_name" as "physical_sales_customer_last_name",
    "uneven"."physical_sales_customer_first_name" as "physical_sales_customer_first_name",
