...
WHERE
    "sales_bill_address_customer_address"."CA_GMT_OFFSET" = -5 and "sales_date_date"."D_YEAR" = 2001 and "sales_date_date"."D_MOY" = 2 and "uneven"."sales_item_name" in (select uneven."color_ids" from uneven where uneven."color_ids" is not null)
...
FROM
    "abundant"
WHERE
    "abundant"."sales_item_name" in (select uneven."color_ids" from uneven where uneven."color_ids" is not null)

GROUP BY
    2
ORDER BY 
    "total_sales" asc nulls first,
    "abundant"."sales_item_name" asc nulls first
LIMIT (100)
```
