...
FROM
    "abundant"
WHERE
    INVALID_REFERENCE_BUG = 2001 and INVALID_REFERENCE_BUG = 2 and INVALID_REFERENCE_BUG = -5 and "abundant"."sales_item_text_id" in (select uneven."color_ids" from uneven where uneven."color_ids" is not null)
