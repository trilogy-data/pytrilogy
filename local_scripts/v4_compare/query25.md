...
| --- | --- | --- | --- |
| v4 | 6939 | 114 | 115.25 ms |
| reference | 6893 | 114 | 113.70 ms |
| v4 / ref | 1.01x | 1.00x | 1.01x |
...
SELECT
    ...
    "concerned"."analysis_store_name" as "analysis_store_name",
    "concerned"."analysis_store_text_id" as "analysis_store_text_id",
    sum("concerned"."analysis_catalog_net_profit") as "catalog_sales_profit"
FROM
    "concerned"
GROUP BY
    1,
...
SELECT
    ...
    coalesce("sparkling"."analysis_store_text_id","vacuous"."analysis_store_text_id") as "analysis_store_text_id",
    coalesce("sparkling"."analysis_store_name","vacuous"."analysis_store_name") as "analysis_store_name",
...
FROM
    "sparkling"
    INNER JOIN "vacuous" on "sparkling"."analysis_item_desc" is not distinct from "vacuous"."analysis_item_desc" AND "sparkling"."analysis_item_text_id" = "vacuous"."analysis_item_text_id" AND "sparkling"."analysis_store_name" is not distinct from "vacuous"."analysis_store_name" AND "sparkling"."analysis_store_text_id" is not distinct from "vacuous"."analysis_store_text_id"
ORDER BY 
    coalesce("sparkling"."analysis_item_text_id","vacuous"."analysis_item_text_id") asc,
    coalesce("sparkling"."analysis_item_desc","vacuous"."analysis_item_desc") asc,
    coalesce("sparkling"."analysis_store_text_id","vacuous"."analysis_store_text_id") asc,
    coalesce("sparkling"."analysis_store_name","vacuous"."analysis_store_name") asc
LIMIT (100)
```
