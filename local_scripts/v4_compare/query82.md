...
only in v4 (showing up to 5 of 34):
  ...
  1x  (datetime.date(2000, 6, 29), Decimal('67.28'), 'Arab, financial pol', 270, 'AAAAAAAAECMCAAAA', 191, 11300)
  1x  (datetime.date(2000, 6, 8), Decimal('67.28'), 'Arab, financial pol', 270, 'AAAAAAAAECMCAAAA', 282, 11300)
  1x  (datetime.date(2000, 6, 15), Decimal('67.28'), 'Arab, financial pol', 270, 'AAAAAAAAECMCAAAA', 307, 11300)
...
| --- | --- | --- | --- |
| v4 | 1909 | 42 | 177.99 ms |
| reference | 1583 | 34 | 161.39 ms |
| v4 / ref | 1.21x | 1.24x | 1.10x |
