...
GROUP BY
    ...
    3,
    4,
    coalesce("juicy"."sales_order_id","questionable"."sales_order_id")),
scrawny as (
SELECT
    "sweltering"."sales_item_id" as "sales_item_id",
    count("sweltering"."_virt_filter_order_id_4509973400283298") as "wr_item_present",
    count("sweltering"."_virt_filter_order_id_5221868426357137") as "sr_item_present",
    count("sweltering"."_virt_filter_order_id_9747092284480774") as "cr_item_present"
FROM
    "sweltering"
GROUP BY
    1
...
GROUP BY
    ...
    2,
    3,
    coalesce("juicy"."sales_item_sk","questionable"."sales_item_sk","sales_item_items"."I_ITEM_SK"),
    coalesce("juicy"."sales_order_id","questionable"."sales_order_id")),
sparkling as (
SELECT
...
GROUP BY
    1)
SELECT
    "sparkling"."sales_item_id" as "item_id",
...
FROM
    "scrawny"
    INNER JOIN "sparkling" on "scrawny"."sales_item_id" is not distinct from "sparkling"."sales_item_id"
ORDER BY 
