...
questionable as (
SELECT
    "cooperative"."ss_store_state" as "_top_states_ts_state",
    "cooperative"."state_rnk" as "state_rnk"
FROM
    "cooperative"),
abundant as (
SELECT
    "questionable"."_top_states_ts_state" as "_top_states_ts_state"
FROM
    "questionable"
WHERE
...
uneven as (
SELECT
    "abundant"."_top_states_ts_state" as "top_states_ts_state"
FROM
    "abundant"),
yummy as (
SELECT
...
FROM
    ...
    INNER JOIN "memory"."date_dim" as "ss_sale_date_date" on "ss_store_sales"."SS_SOLD_DATE_SK" = "ss_sale_date_date"."D_DATE_SK"
WHERE
    "ss_sale_date_date"."D_MONTH_SEQ" BETWEEN 1200 AND 1211 and exists (select 1 from uneven where uneven."top_states_ts_state" is not distinct from "ss_store_store"."S_STATE")
...
SELECT
    ...
    grouping("yummy"."ss_store_county") as "g_county",
    grouping("yummy"."ss_store_state") as "g_state",
    sum("yummy"."ss_net_profit") as "total_sum"
FROM
    "yummy"
GROUP BY
    ROLLUP (2, 1)),
