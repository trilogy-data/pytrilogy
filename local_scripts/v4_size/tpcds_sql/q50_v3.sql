...
SELECT
    ...
    count(CASE WHEN "cheerful"."days_to_return" > -1 and "cheerful"."days_to_return" <= 30 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_2164836669115738",
    count(CASE WHEN "cheerful"."days_to_return" > 120 and "cheerful"."days_to_return" <= 99999 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_77459047872674",
    count(CASE WHEN "cheerful"."days_to_return" > 30 and "cheerful"."days_to_return" <= 60 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_5152376548599237",
    count(CASE WHEN "cheerful"."days_to_return" > 60 and "cheerful"."days_to_return" <= 90 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_2266798048195902",
    count(CASE WHEN "cheerful"."days_to_return" > 90 and "cheerful"."days_to_return" <= 120 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_3765878766448650"
FROM
    "cheerful"
GROUP BY
    1,
...
FROM
    ...
    INNER JOIN "questionable" on "store_sales_store_store"."S_STORE_SK" = "questionable"."store_sales_store_sk"
ORDER BY 
