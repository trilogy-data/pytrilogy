...
wakeful as (
SELECT
    "inv_warehouse_inventory"."inv_item_sk" as "inv_item_ids"
FROM
...
WHERE
    "items_items"."I_CURRENT_PRICE" BETWEEN 68 AND 98 and ("items_items"."I_MANUFACT_ID" is not null and "items_items"."I_MANUFACT_ID" in (677,940,694,808)) and exists (select 1 from wakeful where wakeful."inv_item_ids" is not distinct from "items_items"."I_ITEM_SK")
