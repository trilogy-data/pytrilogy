...
SELECT
    ...
    sum("store_sales_store_sales"."SS_SALES_PRICE") as "revenue"
FROM
...
FROM
    ...
    INNER JOIN "questionable" on "cheerful"."store_sales_store_sk" = "questionable"."store_sales_store_sk"
    LEFT OUTER JOIN "memory"."store" as "store_sales_store_store" on "cheerful"."store_sales_store_sk" = "store_sales_store_store"."S_STORE_SK"
WHERE
    "cheerful"."revenue" <= 0.1 * "questionable"."store_avg_revenue"
...
GROUP BY
    ...
    5,
    6,
    "questionable"."store_avg_revenue"
ORDER BY 
