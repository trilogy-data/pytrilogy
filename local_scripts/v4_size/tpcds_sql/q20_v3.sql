...
WHERE
    ("cs_item_items"."I_CATEGORY" is not null and "cs_item_items"."I_CATEGORY" in ('Sports','Books','Home')) and cast("cs_sale_date_date"."D_DATE" as date) BETWEEN date '1999-02-22' AND date '1999-03-24'
...
ORDER BY 
    ...
    "cheerful"."cs_item_id" asc nulls first,
