...
vacuous as (
SELECT
    "uneven"."_ss_grouped_ss_profit" as "ss_grouped_ss_profit",
    "uneven"."_ss_grouped_ss_sales" as "ss_grouped_ss_sales",
    "uneven"."_ss_grouped_ss_store_id" as "ss_grouped_ss_store_id"
FROM
    "uneven"),
cheerful as (
SELECT
...
concerned as (
SELECT
    "questionable"."sr_grouped_sr_loss" as "sr_grouped_sr_loss",
    "questionable"."sr_grouped_sr_returns" as "sr_grouped_sr_returns",
    "vacuous"."ss_grouped_ss_profit" as "ss_grouped_ss_profit",
    "vacuous"."ss_grouped_ss_sales" as "ss_grouped_ss_sales",
    coalesce("questionable"."sr_grouped_sr_store_id","vacuous"."ss_grouped_ss_store_id") as "sr_grouped_sr_store_id",
    coalesce("questionable"."sr_grouped_sr_store_id","vacuous"."ss_grouped_ss_store_id") as "ss_grouped_ss_store_id"
FROM
    "vacuous"
    LEFT OUTER JOIN "questionable" on "vacuous"."ss_grouped_ss_store_id" is not distinct from "questionable"."sr_grouped_sr_store_id")
SELECT
    :u_channel_s as "u_channel_s",
    "concerned"."ss_grouped_ss_store_id" as "u_id_s",
    cast("concerned"."ss_grouped_ss_sales" as numeric(15,2)) as "u_sales_s",
    cast(coalesce("concerned"."sr_grouped_sr_returns",0) as numeric(15,2)) as "u_returns_s",
    "concerned"."ss_grouped_ss_profit" - cast(coalesce("concerned"."sr_grouped_sr_loss",0) as numeric(15,2)) as "u_profit_s"
FROM
    "concerned"
ORDER BY 
