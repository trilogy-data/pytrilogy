...
SELECT
    ...
    "inventory_warehouse_inventory"."inv_warehouse_sk" as "inventory_warehouse_sk",
...
GROUP BY
    ...
    2)
SELECT
    "wakeful"."inventory_warehouse_sk" as "wsk1",
    "wakeful"."inventory_item_sk" as "isk1",
    1 as "dmoy1",
	...
	END as "cov1",
    "wakeful"."inventory_warehouse_sk" as "wsk2",
    "wakeful"."inventory_item_sk" as "isk2",
    2 as "dmoy2",
