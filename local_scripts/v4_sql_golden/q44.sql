...
SELECT
    ...
    avg("ss_store_sales"."SS_NET_PROFIT") as "_virt_agg_avg_7707029941687820_wscope"
FROM
...
SELECT
    "ss_store_sales"."SS_ITEM_SK" as "ss_item_sk",
    "ss_store_sales"."SS_NET_PROFIT" as "_virt_filter_net_profit_2835528987416348"
FROM
    "memory"."store_sales" as "ss_store_sales"
WHERE
    "ss_store_sales"."SS_STORE_SK" = 1
...
ORDER BY 
    "abhorrent"."rnk" asc nulls first,
    "abhorrent"."ascending_best_performing" desc nulls first,
    "late"."descending_worst_performing" desc nulls first
LIMIT (100)