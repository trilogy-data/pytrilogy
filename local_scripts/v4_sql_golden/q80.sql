...
WHERE
    cast("sales_sale_date_date"."D_DATE" as date) >= date '2000-08-23' and cast("sales_sale_date_date"."D_DATE" as date) <= date '2000-09-22' and "sales_item_items"."I_CURRENT_PRICE" > 50 and "sales_promotion_promotion"."P_CHANNEL_TV" = 'N'
)
SELECT
