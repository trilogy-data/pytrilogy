...
WHERE
    "sales_web_sales_unified"."WS_BILL_CUSTOMER_SK" is not null and "sales_sale_date_date"."D_YEAR" = 2001 and "sales_sale_date_date"."D_MOY" BETWEEN 4 AND 6 and  'WEB'  = 'WEB'
...
WHERE
    "sales_store_sales_unified"."SS_CUSTOMER_SK" is not null and "sales_sale_date_date"."D_YEAR" = 2001 and "sales_sale_date_date"."D_MOY" BETWEEN 4 AND 6 and  'STORE'  = 'STORE'
...
WHERE
    "sales_catalog_sales_unified"."CS_SHIP_CUSTOMER_SK" is not null and "sales_sale_date_date"."D_YEAR" = 2001 and "sales_sale_date_date"."D_MOY" BETWEEN 4 AND 6 and  'CATALOG'  = 'CATALOG'
...
GROUP BY
    ...
    7
ORDER BY 
    "customer_current_demographics_customer_demographics"."CD_GENDER" asc,
    "customer_current_demographics_customer_demographics"."CD_MARITAL_STATUS" asc,
    "customer_current_demographics_customer_demographics"."CD_EDUCATION_STATUS" asc,
    "customer_current_demographics_customer_demographics"."CD_PURCHASE_ESTIMATE" asc,
    "customer_current_demographics_customer_demographics"."CD_CREDIT_RATING" asc
LIMIT (100)