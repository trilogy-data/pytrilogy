...
WHERE
    "ss_sale_date_date"."D_YEAR" = 2000 and "sparkling"."_virt_presence_334607598686241" is not null and "sparkling"."_virt_presence_9866050310038537" is not null and "uneven"."_virt_presence_9232186781707329" is not null
),
puzzled as (
SELECT
...
FROM
    ...
    LEFT OUTER JOIN "memory"."customer_demographics" as "ss_customer_current_demographics_customer_demographics" on "uneven"."ss_customer_current_demographics_sk" = "ss_customer_current_demographics_customer_demographics"."CD_DEMO_SK"
WHERE
    "ss_sale_date_date"."D_YEAR" = 1999 and "sparkling"."_virt_presence_334607598686241" is not null and "sparkling"."_virt_presence_9866050310038537" is not null and "uneven"."_virt_presence_9232186781707329" is not null
),
scrawny as (
SELECT
