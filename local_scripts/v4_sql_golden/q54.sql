...
WHERE
    "ss_sale_date_date"."D_MONTH_SEQ" >= 1188 and "ss_sale_date_date"."D_MONTH_SEQ" <= 1190 and "ss_store_store"."S_COUNTY" = "ss_customer_current_address_customer_address"."CA_COUNTY" and "ss_store_store"."S_STATE" = "ss_customer_current_address_customer_address"."CA_STATE" and "ss_store_sales"."SS_CUSTOMER_SK" is not null and exists (select 1 from questionable where questionable."my_customers_my_cust_id" is not distinct from "ss_store_sales"."SS_CUSTOMER_SK")
...
GROUP BY
    ...
    "ss_customer_current_address_customer_address"."CA_STATE",
    "ss_sale_date_date"."D_MONTH_SEQ",
    "ss_store_sales"."SS_ITEM_SK",
    "ss_store_sales"."SS_SOLD_DATE_SK",
    "ss_store_sales"."SS_STORE_SK",
    "ss_store_sales"."SS_TICKET_NUMBER",
    "ss_store_store"."S_COUNTY",
    "ss_store_store"."S_STATE"),
sweltering as (
SELECT
    "abhorrent"."ss_customer_sk" as "my_revenue_rev_cust_id",
    sum("abhorrent"."ss_ext_sales_price") as "my_revenue_revenue"
FROM
    "abhorrent"
GROUP BY
    1),
...
FROM
    "sweltering")
SELECT
    "scrawny"."segment" as "segment",
    "friendly"."num_customers" as "num_customers",
    "scrawny"."segment_base" as "segment_base"
FROM
    "friendly"
...
GROUP BY
    ...
    3
ORDER BY 
    "scrawny"."segment" asc nulls first,
    "friendly"."num_customers" asc nulls first,
    "scrawny"."segment_base" asc nulls first
LIMIT (100)