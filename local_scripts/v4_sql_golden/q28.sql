...
wakeful as (
SELECT
    "quizzical"."bucket_id" as "bucket_id",
    avg("quizzical"."filtered_lp") as "lp_avg",
    count("quizzical"."filtered_lp") as "lp_cnt",
    count(distinct "quizzical"."filtered_lp") as "lp_cntd"
FROM
    "quizzical"
GROUP BY
    1),
...
SELECT
    "quizzical"."bucket_id" as "bucket_id",
    CASE WHEN "quizzical"."bucket_id" = 1 THEN "wakeful"."lp_avg" ELSE NULL END as "_virt_filter_lp_avg_9807684414024497",
    CASE WHEN "quizzical"."bucket_id" = 1 THEN "wakeful"."lp_cntd" ELSE NULL END as "_virt_filter_lp_cntd_5327557161933280",
    CASE WHEN "quizzical"."bucket_id" = 1 THEN coalesce("wakeful"."lp_cnt",0) ELSE NULL END as "_virt_filter_lp_cnt_2224516900884374",
    CASE WHEN "quizzical"."bucket_id" = 2 THEN "wakeful"."lp_avg" ELSE NULL END as "_virt_filter_lp_avg_2861588206160358",
    CASE WHEN "quizzical"."bucket_id" = 2 THEN "wakeful"."lp_cntd" ELSE NULL END as "_virt_filter_lp_cntd_7846943073851735",
    CASE WHEN "quizzical"."bucket_id" = 2 THEN coalesce("wakeful"."lp_cnt",0) ELSE NULL END as "_virt_filter_lp_cnt_6858115141264011",
    CASE WHEN "quizzical"."bucket_id" = 3 THEN "wakeful"."lp_avg" ELSE NULL END as "_virt_filter_lp_avg_2850673729313768",
    CASE WHEN "quizzical"."bucket_id" = 3 THEN "wakeful"."lp_cntd" ELSE NULL END as "_virt_filter_lp_cntd_5736325163174944",
    CASE WHEN "quizzical"."bucket_id" = 3 THEN coalesce("wakeful"."lp_cnt",0) ELSE NULL END as "_virt_filter_lp_cnt_894357222675893",
    CASE WHEN "quizzical"."bucket_id" = 4 THEN "wakeful"."lp_avg" ELSE NULL END as "_virt_filter_lp_avg_4880359626544039",
    CASE WHEN "quizzical"."bucket_id" = 4 THEN "wakeful"."lp_cntd" ELSE NULL END as "_virt_filter_lp_cntd_7690745280661633",
    CASE WHEN "quizzical"."bucket_id" = 4 THEN coalesce("wakeful"."lp_cnt",0) ELSE NULL END as "_virt_filter_lp_cnt_3577078747089769",
    CASE WHEN "quizzical"."bucket_id" = 5 THEN "wakeful"."lp_avg" ELSE NULL END as "_virt_filter_lp_avg_284549201004209",
    CASE WHEN "quizzical"."bucket_id" = 5 THEN "wakeful"."lp_cntd" ELSE NULL END as "_virt_filter_lp_cntd_3739216114026085",
    CASE WHEN "quizzical"."bucket_id" = 5 THEN coalesce("wakeful"."lp_cnt",0) ELSE NULL END as "_virt_filter_lp_cnt_1394773238248231",
    CASE WHEN "quizzical"."bucket_id" = 6 THEN "wakeful"."lp_avg" ELSE NULL END as "_virt_filter_lp_avg_9446332470240154",
    CASE WHEN "quizzical"."bucket_id" = 6 THEN "wakeful"."lp_cntd" ELSE NULL END as "_virt_filter_lp_cntd_3811294399709285",
    CASE WHEN "quizzical"."bucket_id" = 6 THEN coalesce("wakeful"."lp_cnt",0) ELSE NULL END as "_virt_filter_lp_cnt_8966209673081292"
FROM
    "quizzical"
    INNER JOIN "wakeful" on "quizzical"."bucket_id" is not distinct from "wakeful"."bucket_id"),
cooperative as (
SELECT
