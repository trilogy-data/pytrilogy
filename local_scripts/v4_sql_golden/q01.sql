...
FROM
    "cooperative"
    INNER JOIN "abundant" on "cooperative"."ss_return_store_sk" is not distinct from "abundant"."ss_return_store_sk"
    LEFT OUTER JOIN "memory"."customer" as "ss_return_customer_customers" on "cooperative"."ss_return_customer_sk" = "ss_return_customer_customers"."C_CUSTOMER_SK"
WHERE
