...
SELECT
    ...
    rank() over (partition by "yummy"."sales_channel" order by cast("yummy"."return_amt" as numeric(15,4)) / cast("yummy"."sale_paid" as numeric(15,4)) asc ) as "currency_rank",
    rank() over (partition by "yummy"."sales_channel" order by cast("yummy"."return_qty" as numeric(15,4)) / cast("yummy"."sale_qty" as numeric(15,4)) asc ) as "return_rank"
FROM
    "yummy"),
young as (
SELECT
    ...
    LOWER("vacuous"."sales_channel")  as "channel"
FROM
    "vacuous")
SELECT
    "young"."channel" as "channel",
    "young"."item" as "item",
