...
concerned as (
SELECT
    "cheerful"."sr_grouped_sr_loss" as "sr_grouped_sr_loss",
    "cheerful"."sr_grouped_sr_returns" as "sr_grouped_sr_returns",
    "uneven"."ss_grouped_ss_profit" as "ss_grouped_ss_profit",
    "uneven"."ss_grouped_ss_sales" as "ss_grouped_ss_sales",
    coalesce("cheerful"."sr_grouped_sr_store_id","uneven"."ss_grouped_ss_store_id") as "sr_grouped_sr_store_id",
    coalesce("cheerful"."sr_grouped_sr_store_id","uneven"."ss_grouped_ss_store_id") as "ss_grouped_ss_store_id"
FROM
    "uneven"
    LEFT OUTER JOIN "cheerful" on "uneven"."ss_grouped_ss_store_id" is not distinct from "cheerful"."sr_grouped_sr_store_id")
SELECT
