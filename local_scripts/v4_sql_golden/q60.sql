...
WHERE
    exists (select 1 from uneven where uneven."music_item_ids" is not distinct from "sales_item_items"."I_ITEM_ID") and "sales_pos_bill_address_customer_address"."CA_GMT_OFFSET" = -5 and "sales_sale_date_date"."D_YEAR" = 1998 and "sales_sale_date_date"."D_MOY" = 9
