...
SELECT
    ...
    1.2 * avg("thoughtful"."_virt_agg_sum_1425260143648354_wscope") as "_virt_func_multiply_8336603618679136_wscope"
FROM
    "thoughtful"
GROUP BY
    1),
...
SELECT
    ...
    "thoughtful"."ws_return_customer_sk" as "ws_return_customer_sk"
FROM
    "thoughtful"
    INNER JOIN "abundant" on "thoughtful"."ws_return_address_state" is not distinct from "abundant"."ws_return_address_state"
WHERE
    "thoughtful"."customer_state_returns_2002" > "abundant"."_virt_func_multiply_8336603618679136_wscope"
)
SELECT
    "sparkling"."ws_return_customer_id" as "ws_return_customer_id",
    "sparkling"."ws_return_customer_salutation" as "ws_return_customer_salutation",
    "sparkling"."ws_return_customer_first_name" as "ws_return_customer_first_name",
    "sparkling"."ws_return_customer_last_name" as "ws_return_customer_last_name",
    "sparkling"."ws_return_customer_preferred_cust_flag" as "ws_return_customer_preferred_cust_flag",
    "sparkling"."ws_return_customer_birth_day" as "ws_return_customer_birth_day",
    "sparkling"."ws_return_customer_birth_month" as "ws_return_customer_birth_month",
    "sparkling"."ws_return_customer_birth_year" as "ws_return_customer_birth_year",
    "sparkling"."ws_return_customer_birth_country" as "ws_return_customer_birth_country",
    "sparkling"."ws_return_customer_login" as "ws_return_customer_login",
    "sparkling"."ws_return_customer_email_address" as "ws_return_customer_email_address",
    "sparkling"."ws_return_customer_last_review_date" as "ws_return_customer_last_review_date",
    "yummy"."customer_state_returns_2002" as "customer_state_returns_2002"
FROM
    "yummy"
    INNER JOIN "sparkling" on "yummy"."ws_return_customer_sk" = "sparkling"."ws_return_customer_sk"
ORDER BY 
    "sparkling"."ws_return_customer_id" asc nulls first,
    "sparkling"."ws_return_customer_salutation" asc nulls first,
    "sparkling"."ws_return_customer_first_name" asc nulls first,
    "sparkling"."ws_return_customer_last_name" asc nulls first,
    "sparkling"."ws_return_customer_preferred_cust_flag" asc nulls first,
    "sparkling"."ws_return_customer_birth_day" asc nulls first,
    "sparkling"."ws_return_customer_birth_month" asc nulls first,
    "sparkling"."ws_return_customer_birth_year" asc nulls first,
    "sparkling"."ws_return_customer_birth_country" asc nulls first,
    "sparkling"."ws_return_customer_login" asc nulls first,
    "sparkling"."ws_return_customer_email_address" asc nulls first,
    "sparkling"."ws_return_customer_last_review_date" asc nulls first,
