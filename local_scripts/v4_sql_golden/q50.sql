...
cheerful as (
SELECT
    "store_sales_return_date_date"."D_DATE_SK" as "store_sales_return_date_sk",
...
SELECT
    ...
    count(CASE WHEN "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" > -1 and "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" <= 30 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_2164836669115738",
    count(CASE WHEN "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" > 120 and "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" <= 99999 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_77459047872674",
    count(CASE WHEN "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" > 30 and "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" <= 60 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_5152376548599237",
    count(CASE WHEN "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" > 60 and "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" <= 90 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_2266798048195902",
    count(CASE WHEN "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" > 90 and "cheerful"."store_sales_return_date_sk" - "cheerful"."store_sales_sale_date_sk" <= 120 THEN "cheerful"."store_sales_item_sk" ELSE NULL END) as "_virt_agg_count_3765878766448650"
FROM
    "cheerful"
GROUP BY
    1,
...
cooperative as (
SELECT
    "thoughtful"."store_sales_store_sk" as "store_sales_store_sk",
    sum("thoughtful"."_virt_agg_count_2164836669115738") as "days_30",
    sum("thoughtful"."_virt_agg_count_2266798048195902") as "days_61_90",
    sum("thoughtful"."_virt_agg_count_3765878766448650") as "days_91_120",
    sum("thoughtful"."_virt_agg_count_5152376548599237") as "days_31_60",
    sum("thoughtful"."_virt_agg_count_77459047872674") as "days_120_plus"
FROM
    "thoughtful"
GROUP BY
    1)
SELECT
    ...
    "cooperative"."days_30" as "days_30",
    "cooperative"."days_31_60" as "days_31_60",
    "cooperative"."days_61_90" as "days_61_90",
    "cooperative"."days_91_120" as "days_91_120",
    "cooperative"."days_120_plus" as "days_120_plus"
FROM
    "memory"."store" as "store_sales_store_store"
    INNER JOIN "cooperative" on "store_sales_store_store"."S_STORE_SK" = "cooperative"."store_sales_store_sk"
ORDER BY 
