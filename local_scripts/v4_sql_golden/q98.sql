...
SELECT
    ...
    "cheerful"."store_sales_item_class" as "store_sales_item_class",
    "cheerful"."store_sales_item_sk" as "store_sales_item_sk",
...
SELECT
    ...
    ( "thoughtful"."item_revenue" * 100.0 ) / ("cooperative"."_virt_agg_sum_7595906549305205") as "revenueratio"
FROM
    "cooperative"
    INNER JOIN "thoughtful" on "cooperative"."store_sales_item_class" is not distinct from "thoughtful"."store_sales_item_class")
SELECT
...
FROM
    "questionable"
    LEFT OUTER JOIN "memory"."item" as "store_sales_item_items" on "questionable"."store_sales_item_sk" = "store_sales_item_items"."I_ITEM_SK"
ORDER BY 
    "questionable"."store_sales_item_category" asc nulls first,
    "questionable"."store_sales_item_class" asc nulls first,
    "store_sales_item_items"."I_ITEM_ID" asc nulls first,
    "store_sales_item_items"."I_ITEM_DESC" asc nulls first,
