"""Long-form drilldown bodies for ``trilogy agent-info``.

The command group that prints these lives in ``trilogy/scripts/agent_info.py``;
the compact routing directory lives in ``directory.py`` and the CLI drilldown in
``cli.py``.
"""
