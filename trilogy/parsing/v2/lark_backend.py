...
def _handle_unexpected_token(e: UnexpectedToken, text: str) -> None:
    ...
    if non_agg_by_pos is not None:
        raise create_syntax_error(213, non_agg_by_pos, text)
    ...
    if named_fn_pos is not None:
        raise create_syntax_error(227, named_fn_pos, text)
    ...
    if trailing_pos is not None:
        raise create_syntax_error(231, trailing_pos, text)
    ...
    if misplaced is not None and _lark_parses(
