...
def _local_property_conditions(
...
) -> tuple[BuildConditionContext | None, list[BuildConcept]]:
    ...
    if condition is None:
        return None, []
    return BuildConditionContext.from_where_clause(
        BuildWhereClause(conditional=condition)
    ), unique(condition_concepts, "address")
