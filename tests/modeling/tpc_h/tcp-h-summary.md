...
Trilogy execution is faster than the reference SQL for 8/22 queries. Total Trilogy execution time is 0.480s vs 0.491s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.005s | +0.001s | +0.005s |
| Trilogy vs Reference SQL | -27.5% | +5.3% | +26.8% |
| Trilogy / Reference SQL | 0.72x | 1.05x | 1.27x |
...
| 03 | 0.025s | 0.019s | +0.006s |
| 11 | 0.032s | 0.027s | +0.005s |
| 19 | 0.016s | 0.013s | +0.003s |
| 13 | 0.040s | 0.038s | +0.003s |
...
Trilogy execution is faster than the reference SQL for 0/1 queries. Total Trilogy execution time is 0.023s vs 0.018s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | +0.005s | +0.005s | +0.005s |
| Trilogy vs Reference SQL | +25.3% | +25.3% | +25.3% |
...
| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02.region | 0.023s | 0.018s | +0.005s |
