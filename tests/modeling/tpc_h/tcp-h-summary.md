...
Trilogy execution is faster than the reference SQL for 4/22 queries. Total Trilogy execution time is 0.884s vs 0.641s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.001s | +0.005s | +0.035s |
| Trilogy vs Reference SQL | -2.3% | +22.8% | +100.3% |
| Trilogy / Reference SQL | 0.98x | 1.23x | 2.00x |
