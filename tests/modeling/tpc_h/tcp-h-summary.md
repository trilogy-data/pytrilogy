...
Trilogy execution is faster than the reference SQL for 7/22 queries. Total Trilogy execution time is 0.418s vs 0.427s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.005s | +0.001s | +0.008s |
| Trilogy vs Reference SQL | -27.2% | +6.9% | +37.1% |
| Trilogy / Reference SQL | 0.73x | 1.07x | 1.37x |
...
| Trilogy vs Reference SQL | +73.2% | +73.2% | +73.2% |
