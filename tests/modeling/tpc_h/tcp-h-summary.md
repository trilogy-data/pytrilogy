...
Trilogy execution is faster than the reference SQL for 6/22 queries. Total Trilogy execution time is 0.313s vs 0.319s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.004s | +0.000s | +0.005s |
| Trilogy vs Reference SQL | -25.8% | +9.3% | +37.0% |
| Trilogy / Reference SQL | 0.74x | 1.09x | 1.37x |
...
| 02 | 0.017s | 0.011s | +0.006s |
| 03 | 0.018s | 0.013s | +0.005s |
...
Trilogy execution is faster than the reference SQL for 0/1 queries. Total Trilogy execution time is 0.016s vs 0.010s reference SQL time.
...
| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02.region | 0.016s | 0.010s | +0.006s |
