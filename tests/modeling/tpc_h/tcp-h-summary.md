...
Trilogy execution is faster than the reference SQL for 6/22 queries. Total Trilogy execution time is 0.327s vs 0.587s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.004s | +0.001s | +0.005s |
| Trilogy vs Reference SQL | -34.7% | +6.7% | +33.4% |
| Trilogy / Reference SQL | 0.65x | 1.07x | 1.33x |
...
| 02 | 0.017s | 0.013s | +0.005s |
| 21 | 0.044s | 0.042s | +0.002s |
...
| Trilogy vs Reference SQL | +59.6% | +59.6% | +59.6% |
