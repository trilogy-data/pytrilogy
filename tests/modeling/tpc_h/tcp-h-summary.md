...
Trilogy execution is faster than the reference SQL for 5/22 queries. Total Trilogy execution time is 0.613s vs 0.586s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.007s | +0.001s | +0.011s |
| Trilogy vs Reference SQL | -21.8% | +7.6% | +31.7% |
| Trilogy / Reference SQL | 0.78x | 1.08x | 1.32x |
...
| 21 | 0.093s | 0.078s | +0.014s |
| 03 | 0.037s | 0.025s | +0.012s |
| 11 | 0.044s | 0.034s | +0.010s |
| 02 | 0.033s | 0.025s | +0.008s |
...
Trilogy execution is faster than the reference SQL for 0/1 queries. Total Trilogy execution time is 0.039s vs 0.022s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | +0.017s | +0.017s | +0.017s |
| Trilogy vs Reference SQL | +76.5% | +76.5% | +76.5% |
...
| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02.region | 0.039s | 0.022s | +0.017s |
