...
Trilogy execution is faster than the reference SQL for 6/22 queries. Total Trilogy execution time is 0.257s vs 0.256s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.002s | +0.000s | +0.004s |
| Trilogy vs Reference SQL | -21.7% | +5.3% | +34.9% |
| Trilogy / Reference SQL | 0.78x | 1.05x | 1.35x |

Top 5 queries where reference SQL is fastest vs Trilogy

| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 04 | 0.017s | 0.010s | +0.008s |
| 02 | 0.015s | 0.010s | +0.005s |
| 03 | 0.016s | 0.012s | +0.004s |
| 11 | 0.014s | 0.011s | +0.003s |
| 21 | 0.028s | 0.025s | +0.003s |
...
| Trilogy vs Reference SQL | +69.3% | +69.3% | +69.3% |
...
| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02.region | 0.014s | 0.009s | +0.006s |
