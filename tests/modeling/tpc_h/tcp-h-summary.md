...
Trilogy execution is faster than the reference SQL for 6/22 queries. Total Trilogy execution time is 0.420s vs 0.415s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.004s | +0.001s | +0.006s |
| Trilogy vs Reference SQL | -20.2% | +5.1% | +36.6% |
| Trilogy / Reference SQL | 0.80x | 1.05x | 1.37x |

Top 5 queries where reference SQL is fastest vs Trilogy

| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 04 | 0.030s | 0.015s | +0.015s |
| 03 | 0.027s | 0.017s | +0.009s |
| 11 | 0.025s | 0.019s | +0.006s |
| 02 | 0.023s | 0.016s | +0.006s |
| 13 | 0.034s | 0.030s | +0.004s |
...
Trilogy execution is faster than the reference SQL for 0/1 queries. Total Trilogy execution time is 0.025s vs 0.014s reference SQL time.
...
| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02.region | 0.025s | 0.014s | +0.011s |
