...
LIMIT 100;"""
    ...
    assert 'store_sales.return_time.id' in [x.address for x in r1.where_clause.conditional.concept_arguments], [x.address for x in r1.where_clause.conditional.concept_arguments]