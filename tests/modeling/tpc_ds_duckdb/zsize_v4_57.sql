...
FROM
    "abundant"
    FULL JOIN "uneven" on "abundant"."catalog_sales_call_center_name" = "uneven"."catalog_sales_call_center_name" AND "abundant"."catalog_sales_date_year" = "uneven"."catalog_sales_date_year" AND "abundant"."catalog_sales_item_brand_name" = "uneven"."catalog_sales_item_brand_name" AND "abundant"."catalog_sales_item_category" is not distinct from "uneven"."catalog_sales_item_category")
SELECT
...
ORDER BY 
    "yummy"."sum_sales" - "yummy"."avg_monthly_sales" asc nulls first,
