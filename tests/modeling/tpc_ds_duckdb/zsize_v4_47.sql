...
abundant as (
SELECT
    "questionable"."physical_sales_date_year" as "physical_sales_date_year",
    ...
    "questionable"."physical_sales_store_company_name" as "physical_sales_store_company_name",
    "questionable"."physical_sales_store_name" as "physical_sales_store_name",
    avg("questionable"."sum_sales") as "avg_monthly_sales"
FROM
    "questionable"
WHERE
    "questionable"."physical_sales_date_year" = 1999
