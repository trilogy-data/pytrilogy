...
Trilogy execution is faster than the reference SQL for 45/99 queries. Total Trilogy execution time is 18.470s vs 72.205s reference SQL time.

| Performance metric | Avg | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.543s | +0.005s | +0.138s |
| Trilogy vs Reference SQL | +41.5% | +5.6% | +184.6% |
| Trilogy / Reference SQL | 1.42x | 1.06x | 2.85x |
