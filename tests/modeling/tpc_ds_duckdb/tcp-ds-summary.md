...
PreQL is shorter than the reference SQL for 71/99 queries. Total PreQL length is 128,226 chars vs 182,502 reference SQL chars.

| Length metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| PreQL - Reference SQL chars | -1,333 | -216 | +158 |
