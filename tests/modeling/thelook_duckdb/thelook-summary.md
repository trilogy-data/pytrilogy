...
Trilogy execution is faster than the reference SQL for 6/22 queries. Total Trilogy execution time is 0.110s vs 0.100s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.001s | +0.000s | +0.001s |
| Trilogy vs Reference SQL | -13.5% | +6.7% | +41.2% |
| Trilogy / Reference SQL | 0.87x | 1.07x | 1.41x |

Top 5 queries where reference SQL is fastest vs Trilogy

| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02 | 0.008s | 0.004s | +0.005s |
