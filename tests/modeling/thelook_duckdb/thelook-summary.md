...
Trilogy execution is faster than the reference SQL for 11/22 queries. Total Trilogy execution time is 0.148s vs 0.149s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.003s | +0.000s | +0.002s |
| Trilogy vs Reference SQL | -34.8% | +0.1% | +26.8% |
| Trilogy / Reference SQL | 0.65x | 1.00x | 1.27x |

Top 5 queries where reference SQL is fastest vs Trilogy

| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02 | 0.014s | 0.007s | +0.007s |
| 10 | 0.012s | 0.005s | +0.007s |
| 22 | 0.010s | 0.008s | +0.002s |
