...
Trilogy execution is faster than the reference SQL for 8/22 queries. Total Trilogy execution time is 0.146s vs 0.140s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.003s | +0.000s | +0.002s |
| Trilogy vs Reference SQL | -45.6% | +8.5% | +22.1% |
| Trilogy / Reference SQL | 0.54x | 1.08x | 1.22x |

Top 5 queries where reference SQL is fastest vs Trilogy

| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02 | 0.015s | 0.006s | +0.010s |
| 10 | 0.013s | 0.005s | +0.008s |
| 19 | 0.015s | 0.013s | +0.002s |
| 03 | 0.007s | 0.007s | +0.001s |
