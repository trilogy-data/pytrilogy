...
Trilogy execution is faster than the reference SQL for 4/22 queries. Total Trilogy execution time is 0.098s vs 0.089s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.000s | +0.000s | +0.001s |
| Trilogy vs Reference SQL | -4.8% | +12.5% | +35.2% |
| Trilogy / Reference SQL | 0.95x | 1.12x | 1.35x |

Top 5 queries where reference SQL is fastest vs Trilogy

| Query | Trilogy s | Reference SQL s | Trilogy - Reference SQL |
| --- | ---: | ---: | ---: |
| 02 | 0.004s | 0.003s | +0.001s |
| 16 | 0.005s | 0.003s | +0.001s |
| 10 | 0.004s | 0.003s | +0.001s |
| 21 | 0.010s | 0.009s | +0.001s |
