...
Trilogy execution is faster than the reference SQL for 6/18 queries. Total Trilogy execution time is 0.164s vs 0.156s reference SQL time.

| Performance metric | P10 | P50 | P90 |
| --- | ---: | ---: | ---: |
| Trilogy - Reference SQL seconds | -0.001s | +0.000s | +0.001s |
| Trilogy vs Reference SQL | -8.2% | +10.8% | +56.2% |
| Trilogy / Reference SQL | 0.92x | 1.11x | 1.56x |
