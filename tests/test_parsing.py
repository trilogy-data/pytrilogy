...
from preql.parsing.parse_engine import argument_to_purpose, function_args_to_output_purpose
...
def test_argument_to_purpose(test_environment):
    ...
    assert function_args_to_output_purpose(["test", 1.00,]) == Purpose.CONSTANT
