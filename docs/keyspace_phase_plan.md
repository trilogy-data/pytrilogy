...
1. **Owner answer 5 is built** (its section above). Left: `select late_name, count(order_id)` in `OWED`; the HAVING presence probe blocking the sole-output push (q41).
