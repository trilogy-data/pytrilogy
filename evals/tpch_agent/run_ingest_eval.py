...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--scale-factor", type=float, default=0.1, help="TPC-H scale factor"
    )
    parser.add_argument(
        "--num-queries",
        type=int,
...
def main() -> int:
    ...
    print(f"[1/4] Building TPC-H DuckDB (sf={args.scale_factor:g}) ...")
    ...
    print(f"[3/4] Scoring {len(query_ids)} queries against TPC-H reference ...")
