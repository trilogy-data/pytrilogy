...
CREATE OR REPLACE TABLE payroll_entry AS
...
CREATE OR REPLACE TABLE support_ticket_event AS
...
CREATE OR REPLACE TABLE marketing_campaign AS
...
CREATE OR REPLACE TABLE marketing_touch AS
...
CREATE OR REPLACE TABLE supplier_contract AS
...
CREATE OR REPLACE TABLE fleet_vehicle AS
...
CREATE OR REPLACE TABLE fleet_maintenance AS
...
CREATE OR REPLACE TABLE project_milestone AS
...
CREATE OR REPLACE TABLE application_audit_event AS
