...
**Re-verified PARTIALLY OPEN 2026-08-16 (`a65b13c9c`) — the crash narrative is obsolete.** `LocalFileBackend._resolve` is still verbatim `Path(raw).expanduser()` with no workspace clamp.
