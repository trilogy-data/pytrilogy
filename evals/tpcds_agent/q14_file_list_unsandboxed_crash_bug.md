...
**Re-verified PARTIALLY OPEN 2026-08-20 (`6bdb4d7b4`) — the crash narrative is obsolete.** `LocalFileBackend._resolve` is still verbatim `Path(raw).expanduser()` with no workspace clamp.
