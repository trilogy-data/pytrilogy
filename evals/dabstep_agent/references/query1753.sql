-- DABstep task 1753 (hard): What are the applicable fee IDs for
-- Belles_cookbook_store in March 2023? Published answer: 34 ids
-- (validated exact). Same matching semantics as query1681.sql.
WITH txn AS (
    SELECT p.*,
